...
class PageTransitions {
    ...
    setupNavigationInterception() {
        ...
        navLinks.forEach(link => {
            if (link.hostname !== window.location.hostname || link.getAttribute('href').startsWith('#') || link.hasAttribute('target')) {
                return;
            }
...
class MicroInteractions {
    ...
    setupInteractiveElements() {
        const interactiveElements = document.querySelectorAll('.service-card, .credential-card, .video-testimonial-card, .nav-link');
